...
# Escape forward slashed in caseDir
caseDirSlash=`echo ${caseDir} | sed "s/\//xxx/g"`
echo ${caseDirSlash}
...
cat load_metv_mariadb_TMPL.xml | sed "s/DATABASE_NAME/${dbName}/g;s/CASE_DIR/${caseDirSlash}/g" \
    > load_${dbName}.xml
