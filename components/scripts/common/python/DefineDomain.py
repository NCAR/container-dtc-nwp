...
def calc_wps_domain_info(wps_file):
    ...
    if ndomain>1:
        ...
        e_we_full = e_we_array
        e_ns_full = e_ns_array
        length_x = dx_full[0]*e_we_full
        length_y = dy_full[0]*e_ns_full
        e_we = e_we_full
        e_ns = e_ns_full
    ...
    return wpsproj, latlonproj, corner_lat_full, corner_lon_full, length_x, length_y, ndomain
