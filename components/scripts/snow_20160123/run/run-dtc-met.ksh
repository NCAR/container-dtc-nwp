...
#
# Simplified script to run MET for the snow case in Docker world
#
...
while [ $FCST_TIME -le $FCST_HR_END ] ; do
  ...
  export RAW_OBS=/case_data/snow_20160123/obs_data/prepbufr
  ...
  if [ $FCST_TIME -ge $ACCUM_TIME ]; then
    ...
    export ACCUM_TIME
    export BUCKET_TIME
    export RAW_OBS=/case_data/snow_20160123/obs_data/qpe
