...
cat plot_TMP_RMSE_singularity.xml | sed "s%METV_OUT_PATH%${METVDir}%g" \
    > ${METVDir}/xml/plot_TMP_RMSE_singularity.xml

# Plot the data
/METviewer/bin/mv_batch.sh ${METVDir}/xml/plot_APCP_03_ETS_singularity.xml
/METviewer/bin/mv_batch.sh ${METVDir}/xml/plot_TMP_RMSE_singularity.xml
